...
npm install
Update API configuration Edit mobile/constants/config.ts and set your backend URL
...
Deploy at least 3-4 beacons per floor
Place beacons at known coordinates
Configure beacon UUID, major, and minor values
Register beacon positions in the database
Calibrate tx_power for your environment
Future Enhancements
